...
//    GROW_ARRAY((void*)(l->groups), l->nb_groups);
                               ...
                               const OptionGroupDef *groups, int nb_groups)
{
    ...
    octx->groups    = (OptionGroupList*)av_mallocz_array((size_t)octx->nb_groups, sizeof(*octx->groups));
    if (!octx->groups)
        exit_program(1);
                                           ...
                                           AVDictionary *codec_opts)
{
    ...
    if (!s->nb_streams)
        return NULL;
//    opts = (Option *)av_mallocz_array(s->nb_streams, sizeof(*opts));
    if (!opts) {
        av_log(NULL, AV_LOG_ERROR,
